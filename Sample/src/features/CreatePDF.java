...
public class CreatePDF {
	...
	public CreatePDF(String path) throws Exception
	{
		 try {
           ...
           image = Image.getInstance (System.getProperty("user.dir")+"\\src\\talktalk.jpg");
              image.scaleAbsolute(550f, 35f);//image width,height
              ...
              PdfPCell Method = new PdfPCell (new Paragraph ("TestCase Name"));
	...
	//LIST IN PDF REPORT.
	  ...
	  public void pdfList() throws Exception
	  {
		  ...
		  pdftablerows = table.getRows().size()-2;
                  ...
                  pdflist.add(new ListItem("Total no of Testcases Executed :" + pdftablerows));
                  pdflist.add(new ListItem("Total no of Testcases Passed During execution :" + pCount));
                  pdflist.add(new ListItem("Total no of Testcases Skipped During execution :" + SCount));
                  pdflist.add(new ListItem("Total no of Testcases Failed During execution :" + (pdftablerows-pCount-SCount)));  
	  }
	  public void addpdf(String InvokedBrowser) throws Exception
	  {
                ...
                Chunk chunk1=new Chunk("for the project TalkTalk - HQA ");
                ...
                document.add(new Paragraph("Hi all,"));
                document.add(chunk);
                document.add(chunk1);
                document.add(chunk2);
                document.add(Chunk.NEWLINE);         
